...
export function AppHeader({ breadcrumbs = [] }: AppHeaderProps) {
    ...
    return (
        <>
            <div className="sticky top-0 z-30 border-sidebar-border/80 border-b bg-white dark:bg-zinc-950 rounded-b-2xl">
                <div className="mx-auto flex h-16 items-center px-4 md:max-w-7xl">
                    ...
                    <Link href={mainNavItems[0].url} prefetch className="flex items-center space-x-2">
                        <AppLogo />
                    </Link>
                    ...
                    <div className="ml-auto flex items-center space-x-2">
                        ...
                        <DropdownMenu>
                            ...
                            <DropdownMenuContent className="w-56 dark:bg-zinc-900" align="end">
