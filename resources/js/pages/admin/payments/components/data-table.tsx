...
export function DataTable<TData, TValue>({
  ...
  const handleSearch = () => {
    router.get(route("admin.payments"), { search: query }, { preserveScroll: true, preserveState: true })
  }
  ...
  return (
    <>
      ...
      <div className="flex flex-row flex-wrap items-center justify-between gap-4 p-4 border-b border-gray-200 dark:border-gray-700">
        ...
        <Button
          onClick={() => router.get(route("admin.payments.create"))}
      ...
      <div className="bg-white dark:bg-zinc-900 border border-gray-200 dark:border-gray-700 p-2 rounded-lg shadow-sm mt-6">
        ...
        >
          ...
          <Button
            type="submit"
            className="bg-zinc-900 text-white hover:bg-zinc-700 dark:hover:bg-zinc-800 whitespace-nowrap"
          >
            <Search />
          </Button>
        </form>
